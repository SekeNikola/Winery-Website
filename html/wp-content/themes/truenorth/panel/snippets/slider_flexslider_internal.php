...
<?php else: ?>
	...
	<fieldset id="ci-panel-slider-flexslider-internal" class="set">
		<legend><?php _e('Internal Slider', 'truenorth'); ?></legend>
		<p class="guide"><?php _e('The following options control the internal slider. You may enable or disable auto-sliding by checking the appropriate option and further control its behavior.' , 'truenorth'); ?></p>
