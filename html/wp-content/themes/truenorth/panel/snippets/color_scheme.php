...
<?php else: ?>
	...
	<fieldset id="ci-panel-color-scheme" class="set">
		<legend><?php _e('Color Scheme', 'truenorth'); ?></legend>
		<p class="guide"><?php _e('Select your color scheme. This affects the overall look and feel of your website.', 'truenorth'); ?></p>
		<?php 
