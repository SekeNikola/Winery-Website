...
<?php else: ?>
	...
	<fieldset id="ci-panel-excerpt" class="set">
		<legend><?php _e('Content Preview', 'truenorth'); ?></legend>

		<fieldset id="ci-panel-excerpt-preview-content">
			<p class="guide"><?php _e('You can select whether you want the Content or the Excerpt to be displayed on listing pages.', 'truenorth'); ?></p>
			<label><?php _e('Use the following on listing pages', 'truenorth'); ?></label>
			<?php
		...
		<fieldset id="ci-panel-excerpt-read-more">
			<p class="guide mt10"><?php _e('You can set what the Read More text will be. This applies to both the Content and the Excerpt.', 'truenorth'); ?></p>
			<?php ci_panel_input( 'read_more_text', __( 'Read More text', 'truenorth' ) ); ?>
		</fieldset>

		<fieldset id="ci-panel-excerpt-excerpt-options">
			<p class="guide mt10"><?php _e('You can define how long the Excerpt will be (in words). You can also set the text that appears when the excerpt is auto-generated and is automatically cut-off. These options only apply to the Excerpt.', 'truenorth'); ?></p>
			<?php
