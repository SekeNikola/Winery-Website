...
<?php else: ?>
	...
	<fieldset id="ci-panel-google-analytics" class="set">
		<legend><?php _e('Google Analytics', 'truenorth'); ?></legend>
		<p class="guide"><?php _e('Paste here your Google Analytics Code, as given by the Analytics website (including the <b>&lt;script&gt;</b> and <b>&lt;/script&gt;</b> tags), and it will be automatically included on every page.', 'truenorth'); ?></p>
