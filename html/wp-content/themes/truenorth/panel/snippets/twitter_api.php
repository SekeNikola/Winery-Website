...
<?php else: ?>
	...
	<fieldset id="ci-panel-twitter" class="set">
		...
		<p class="guide"><?php _e('<strong>Step 4:</strong> Under the <em>Your access token</em> label, you will find your <strong>Access token</strong> and <strong>Access token secret</strong>. Paste them below.', 'truenorth'); ?></p>
